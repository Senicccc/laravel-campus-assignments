...
use App\Http\Controllers\BukuController;use App\Http\Controllers\Member_perpustakaanController;
...
Route::post('/simpanMember', [Member_perpustakaanController::class, 'store' ]);
